...
- Data engineering (incl. data pipelines in DuckDB, and data wrangling in Polars and Narwhals) [🔗 Link](https://github.com/katwre/Data_engineering-projects)
...
- Bayesian formulation of A/B testing using the beta-binomial model (PyMC) [🔗 Link](https://github.com/katwre/Bayesian_inference_ABtesting_PyMC)

...
- AI for developer workflows (2025-2026):
    - An interactive web-based spatial transcriptomics platform that visualizes gene expression with AI-powered gene summaries and region-of-interest suggestions [🔗 Link](https://github.com/katwre/Spatial_explorer_api)

...
- Machine and deep learning end-to-end projects with APIs (2025):
    ...
    - Diffusion-based generative modeling and inpainting of H&E-stained blood cell images, deployed via Streamlit and AWS EC2 [🔗 Link](https://github.com/katwre/Diffusion-models-for-cell-images)
...
- Cross-platform spatial transcriptomics integration - cFFPE-seq, Visium, and Xenium (2026) [🔗 Link](https://github.com/katwre/visium-xenium-scFFPEseqreference-mapping)
...
#### AI dev tools & workflows

- AI dev tools & workflows (2025-2026):
    - An interactive web-based spatial transcriptomics platform that visualizes gene expression, includes a chatbox, AI-powered gene summaries, and optional SpaGCN-based spatial domain analysis via a ChatSpatial MCP server [🔗 Link](https://github.com/katwre/Spatial_explorer_api)
